...
# 2. This creates:
#    - release/CueMe-1.0.60.dmg          (Universal binary)
#    - release/CueMe-1.0.60-arm64.dmg    (Apple Silicon)
#    - release/CueMe-1.0.60-mac.zip      (Archive)
...
- [ ] **Update version number**
  ```bash
  # In package.json
  "version": "1.0.60"  # Increment version
  ```

- [ ] **Commit all changes**
  ```bash
  git add .
  git commit -m "chore: bump version to 1.0.60"
...
1. **Download DMG from GitHub Releases**
   - User downloads `CueMe-1.0.60-arm64.dmg`
